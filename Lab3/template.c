...
#define TIMER_STATUS0	((volatile unsigned int *) 0x10004000)

#define TIMER_CONTROL0	((volatile unsigned int *) 0x10004004)

#define TIMER_START_LO0	((volatile unsigned int *) 0x10004008)

#define TIMER_START_HI0	((volatile unsigned int *) 0x1000400C)

#define TIMER_SNAP_LO0	((volatile unsigned int *) 0x10004010)

#define TIMER_SNAP_HI0	((volatile unsigned int *) 0x10004014)



#define TIMER_STATUS1	((volatile unsigned int *) 0x10004020)

#define TIMER_CONTROL1	((volatile unsigned int *) 0x10004024)

#define TIMER_START_LO1	((volatile unsigned int *) 0x10004028)

#define TIMER_START_HI1	((volatile unsigned int *) 0x1000402C)

#define TIMER_SNAP_LO1	((volatile unsigned int *) 0x10004030)

#define TIMER_SNAP_HI1	((volatile unsigned int *) 0x10004034)
...
#define JTAG_UART_PORT ((volatile unsigned int *) 0x10001000)
...
int isLine = 1;
unsigned int line = 0x30000000;
unsigned int dash = 0x40000000;	   
...
void interrupt_handler(void)
{
   ...
   if (ipending & 0x8000) {
   ...
   else if (ipending & 0x4000) {
	  *TIMER_STATUS1 = *TIMER_STATUS1 & 1;
    ...
    else if (ipending & 0x2000) {
		  *TIMER_STATUS0 = *TIMER_STATUS0 & 1;
		  if (*SWITCHES & 0x1){
			*LEDS = (*LEDS / 2) % 0x400;
		  } else 
			 *LEDS = (*LEDS * 2) % 0x400;
...
void Init (void)
{
   *TIMER_START_LO2 = 0x7840;
   *TIMER_START_HI2 = 0x017D;
   *TIMER_STATUS2 = 0;
   *TIMER_CONTROL2 = 7;


   *TIMER_START_LO1 = 0x5E10;
   *TIMER_START_HI1 = 0x005F;
   *TIMER_STATUS1 = 0;
   *TIMER_CONTROL1 = 7;

   *TIMER_START_LO0 = 0x4B40;
   *TIMER_START_HI0 = 0x004C;
   *TIMER_STATUS0 = 0;
   *TIMER_CONTROL0 = 7;
